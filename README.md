...
def loginSC():
	...
	if username =="solata" and password =="trj":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/erdy_pratama')
				menu()
